...
<body>
	...
	try {
		$selecao = "SELECT compra_produto.cd_produto, fornecedor.nome AS forn_nome, compra_produto.nome, 
								...
								<div class="card-body table-full-width table-responsive">
									<table class="table table-hover" id="lista">
										...
										foreach ($linhas as $exibir_colunas) {
											echo '<tr>';											
											echo '<td title="' . $exibir_colunas['forn_nome'] . '">' . $exibir_colunas['forn_nome'] . '</td>';
											...
											<td class="actions" title="Ações">													
													<a class="btn btn-primary " style="border-radius: 20px;" <a href="/web/form_crud/form_update_produto.php?id=' . $exibir_colunas['cd_produto'] . '">Atualizar</a>
													<a class="btn btn-danger btn-xs"  style="border-radius: 20px;"href="/web/form_crud/form_delete_produto.php?id=' . $exibir_colunas['cd_produto'] . '" >Excluir</a>
												</td>';
											echo '</tr>';
											echo '</p>';
										}
