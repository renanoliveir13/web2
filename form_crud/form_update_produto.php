									...
									<form method="POST" id="atu_forn" autocomplete="off" action="/web/crud/update_produto.php">
										...
										<div class="row">
											<div class="col-md-4 pr-1">
												<div class="form-group">
													...
													<select class="form-control" name="cd_fornecedor" id="cd_fornecedor" required="" title="Caixa de seleção para atualizar o fornecedor">
														...
														<?php foreach ($resultado_fornecedor as $v1) : ?>
															<option <?= ($v1['cd_fornecedor'] == $dados['cd_fornecedor'] ? 'selected' : ''); ?> title="<?= $v1['nome'] ?>" value="<?= $v1['cd_fornecedor'] ?>"><?= $v1['nome'] ?></option>
														<?php endforeach ?>
													</select>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-6 pr-1">
												<div class="form-group">
													...
													<select class="form-control" name="nome" id="nome" required="" title="Caixa de seleção para atualizar o tipo do produto" class="form-control" placeholder="">
													...
													<?php echo '<script>document.getElementById("nome").value = "' . $dados['nome'] . '"</script>'; ?>
										...
										<div class="col-md-6 pl-1">
											<div class="form-group">
												...
												<input type="number" class="form-control" placeholder="" name="quantidade" value="<?= $dados['quantidade']; ?>" required title="Campo para atualizar a quantidade de produtos">
											</div>
										</div>
										<div class="row">
											<div class="col-md-4 pr-1">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="R$" name="valor_compra" value="<?= $dados['valor_compra']; ?>" required title="Campo para atualizar o valor de compra do produto">
												</div>
											</div>
											<div class="col-md-4 px-1">
												<div class="form-group">
													...
													<select class="form-control" name="porcentagem_revenda" id="porcentagem_revenda" value="<?= $dados['porcentagem_revenda']; ?>" required="" title="Caixa de seleção para atualizar a porcentagem de revenda do produto" class="form-control" placeholder="">
														...
														<option value="AC">Escolher</option>
