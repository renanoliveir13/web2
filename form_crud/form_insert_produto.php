										...
										<form>
											<div class="row">
												<div class="col-md-6">
													...
													<select class="form-control" name="cd_fornecedor" id="cd_fornecedor" required="" title="Caixa de seleção para escolher o fornecedor" accesskey="w">
											...
											<div class="row">
												<div class="col-md-6 pr-1">
													<div class="form-group">
														...
														<select class="form-control" name="nome" id="nome" required="" title="Caixa de seleção para escolher o tipo do produto" class="form-control" placeholder="">
