...
<body>
	<?php
		...
		if(isset($_POST['Atualizar'])){
			...
			$cd_produto_venda = $_POST['cd_produto_venda'];
			...
			try {
				...
				$procurar_produto = "SELECT quantidade FROM produtos_venda WHERE cd_produto_venda = :cd_produto_venda LIMIT 1";
				...
				$procura_quantidade_produto_antiga = "SELECT quantidade FROM compra_produto 
				WHERE cd_produto = :cd_produto LIMIT 1";
				...
				$atualizacao = "UPDATE produtos_venda SET cd_produto = :cd_produto, 
				valor_item = :valor_item, quantidade = :quantidade WHERE cd_produto_venda = :cd_produto_venda";
				...
				$atualiza_dados->bindValue(':cd_produto_venda', $cd_produto_venda);
				// Executa a operacao
				...
				if ($quantidade <= $quantidade_antiga) {
					...
					$calculo_reposicao = "UPDATE compra_produto SET quantidade = :quantidade_nova WHERE cd_produto = :cd_produto";		
